...
when defined(windows):
  const dllname = "python(34|27|26|25|24|23|22|21|20|16|15).dll"
elif defined(macosx):
  const dllname = "libpython(3.4|2.7|2.6|2.5|2.4|2.3|2.2|2.1|2.0|1.6|1.5).dylib"
else:
  const dllver = ".1"
  const dllname = "libpython(3.4|2.7|2.6|2.5|2.4|2.3|2.2|2.1|2.0|1.6|1.5).so" &
                  dllver
...
proc PyUnicode_FromString*(u: cstring): PPyObject{.cdecl, importc, dynlib: dllname.}
...
when defined(windows):
  const
    LibNames = ["python34.dll", "python27.dll", "python26.dll", "python25.dll",
      "python24.dll", "python23.dll", "python22.dll", "python21.dll",
      "python20.dll", "python16.dll", "python15.dll"]
elif defined(macosx):
  const
    LibNames = ["libpython3.4.dylib", "libpython2.7.dylib", "libpython2.6.dylib",
